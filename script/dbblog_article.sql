truncate `quick-blog`.article;

INSERT INTO `quick-blog`.article (id, title, description, author, content, content_format, read_num, comment_num, like_num, cover_type, cover, create_time, update_time, recommend, category_id, publish, top) VALUES (1, '关于本站和博主', '关于本站和博主', 'Bobbi', '# 关于我
...
', 51, 0, 1, 1, 'http://oss.dblearn.cn/`quick-blog`/20190303/18a6c1d2ed47494396462901ffe02f30.jpg', '2019-03-09 17:09:38', '2019-03-04 17:41:50', 1, '1,2,3', 1, 1);
INSERT INTO `quick-blog`.article (id, title, description, author, content, content_format, read_num, comment_num, like_num, cover_type, cover, create_time, update_time, recommend, category_id, publish, top) VALUES (3, '2019Java最新面试题——Java基础（持续更新）', '网上找的面试题大多比较老旧，很多还是Java6以前的。现在都更新到Java11了，面试题也应该与时俱进。本文搜罗各大厂的Java面试题，力求题目从简到难，分类明确，答案详细！也借此来巩固自己的知识。', 'Bobbi', '### Java基础
...
', 32, 0, 0, 0, 'http://oss.dblearn.cn/`quick-blog`/20190304/b00399e2664b4c42a3e2b4b23fcf128b.jpeg', '2019-03-09 17:09:38', '2019-03-04 23:24:09', 1, '9,11,12', 1, 0);
...
', 12, 0, 0, 0, 'http://oss.dblearn.cn/`quick-blog`/20190305/d991537084cf42b2889b41838b59df0f.png', '2019-03-09 17:09:38', '2019-03-05 12:59:56', 0, '9,11,12', 1, 0);
